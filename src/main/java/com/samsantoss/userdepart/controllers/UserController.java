...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<User> updateUser(@PathVariable Long id, @RequestBody @Validated User updateUser){
        Optional<User> user = userService.updateUser(id, updateUser);
